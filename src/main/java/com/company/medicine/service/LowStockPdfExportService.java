...
@Service
public class LowStockPdfExportService {

    private static final Logger log = LoggerFactory.getLogger(LowStockPdfExportService.class);
    private static final DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("MM/dd/yyyy");

    public byte[] exportLowStockToPdf(List<Stock> stocks) {
        ...
        try {
            ...
            document.add(new Paragraph("Low Stock Medicines").setBold().setFontSize(18).setTextAlignment(TextAlignment.CENTER).setMarginTop(10));

            document.add(new Paragraph("Total Low Stock Medicines: " + stocks.size()));
