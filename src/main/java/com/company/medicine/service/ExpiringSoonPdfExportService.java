...
@Service
public class ExpiringSoonPdfExportService {

    private static final Logger log = LoggerFactory.getLogger(ExpiringSoonPdfExportService.class);
    private static final DateTimeFormatter dateFormatter = DateTimeFormatter.ofPattern("MM/dd/yyyy");

    public byte[] exportExpiringSoonToPdf(List<Stock> stocks) {
        ...
        try {
            ...
            document.add(new Paragraph("Medicines Expiring Soon").setBold().setFontSize(18).setTextAlignment(TextAlignment.CENTER).setMarginTop(10));

            document.add(new Paragraph("Total Medicines Expiring Soon: " + stocks.size()));
